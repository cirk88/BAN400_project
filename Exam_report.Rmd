...
politicians <- "(president_donald)|(president_obama)|(president_trump)|(barack_obama)|(bernie_sanders)|(donald_trump)|(hillary_clinton)|(bill_clinton)|(ted_cruz)|(vladimir_putin)|(john_mccain)"  	
...
### 4.  The previous steps may take a while to run, alternatively, we could load the data 
...
model_train <- train %>% 
  select(Fake,w_count.txt,punct_count.txt,exclamation_count.txt,w_count.title,punct_count.title, exclamation_count.title, sentiment, politician.pw, media.pw ) %>% 
